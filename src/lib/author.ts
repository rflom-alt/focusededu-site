...
export const author = {
  ...
  // Personal profile used for Person schema `url` (swap for Robert's LinkedIn).
  profileUrl: "https://www.linkedin.com/company/focused-staffing-group",
  links: [
    { label: "LinkedIn", href: "https://www.linkedin.com/company/focused-staffing-group", kind: "linkedin" },
    { label: "Email", href: "mailto:hello@focused-staffing.com", kind: "email" },
    { label: "Instagram", href: "https://www.instagram.com/focusededustaffing.group/", kind: "instagram" },
  ] as AuthorLink[],
};
